...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Pierre Marty" => "p.marty@me.com" }
  # Or just: spec.author    = "Pierre Marty"
  # spec.authors            = { "Pierre Marty" => "p.marty@me.com" }
  # spec.social_media_url   = "https://twitter.com/Pierre Marty"
  ...
  #spec.source       = { :path => '.' }
  spec.source       = { :git => "https://github.com/pierrem/KnobControl.git", :tag => "1.0.0" }
